...
Objects::Pacman::Pacman() : Entity({32.0f, 32.0f}, {0.f, 0.f}, {0.f, 0.f}){
  ...
  this->m_sprites[0] = std::unique_ptr<SDL_Surface>(Utils::loadSDLSurface("resources/pacman_1.bmp"));
  this->m_sprites[1] = std::unique_ptr<SDL_Surface>(Utils::loadSDLSurface("resources/pacman_2.bmp"));
  this->m_sprites[2] = std::unique_ptr<SDL_Surface>(Utils::loadSDLSurface("resources/pacman_3.bmp"));
}
...
void Objects::Pacman::draw(std::shared_ptr<SDL_Surface> base) {
  ...
  SDL_SetColorKey(this->m_sprites[this->m_animation_state].get(), SDL_TRUE, SDL_MapRGB( this->m_sprites[this->m_animation_state].get()->format, 0, 0, 0));
