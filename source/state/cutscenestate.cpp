...
State::CutsceneState::CutsceneState(Application& app)
  ...
  this->m_ghosts.push_back(
      Objects::Ghost(Objects::GhostType::BLINKY, app.renderer(), {13.5 * 16.f - 8, 14 * 16.f - 8}));
  this->m_ghosts.push_back(
      Objects::Ghost(Objects::GhostType::PINKY, app.renderer(), {15.5 * 16.f - 8, 17 * 16.f - 8}));
  this->m_ghosts.push_back(
      Objects::Ghost(Objects::GhostType::INKY, app.renderer(), {11.5 * 16.f - 8, 17 * 16.f - 8}));
  this->m_ghosts.push_back(
